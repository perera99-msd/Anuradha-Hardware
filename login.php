            ...
            <div class="login-container">
                ...
                <div class="login-benefits">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-check"></i> View and track orders</li>
                        <li><i class="fas fa-check"></i> Access your order history</li>
                        <li><i class="fas fa-check"></i> Save items to your wishlist</li>
                        <li><i class="fas fa-check"></i> Get exclusive deals and offers</li>
                    </ul>
                </div>
            </div>
        </div>
